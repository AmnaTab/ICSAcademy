        ...
        <div id="carouselExampleIndicators" className="carousel slide carousel-fade" data-ride="carousel" data-pause="false" data-interval="4000">
          ...
          <div className="carousel-inner">
            ...
            <div className="carousel-item">
              ...
              <Link to="/inscription" className="btn btn-success" role="button" style={{left:50}}> S'inscrire </Link>
              </div>
            </div>          
          </div>
            ...
            <div className="row ">
              <div className="col-lg-8">
                <div className="section-title">
                  <span className="h4 text-color ">Nous sommes des personnes Expertes &amp; Créatives </span><br /><br />
                  <h5 className="">On vous garantie une formation éfficace et un certificat Homologué dans
                    plusieurs domaines technologiques et Soft Skills qui vous facilitent par la suite l'integration au marché d'emploi. </h5>
                </div>
              </div>
            </div>
            <div className="row justify-content-center">
              <div className="col-lg-4 col-md-6 col-12">
                <div className="intro-item mb-5 mb-lg-0">
                  ...
                  <h4 className="mt-4 mb-3">Design moderne &amp; réactif</h4>
              ...
              <div className="col-lg-4 col-md-6">
                <div className="intro-item mb-5 mb-lg-0">
                  ...
                  <h4 className="mt-4 mb-3">Certificat Homologué</h4>
              ...
              <div className="col-lg-4 col-md-6">
                <div className="intro-item">
                  ...
                  <h4 className="mt-4 mb-3">Créez votre site Web de manière professionnelle</h4>
            ...
            <div className="row justify-content-center">
              <div className="col-lg-4 col-md-6 col-sm-6">
                <div className="service-item mb-5">
                  ...
                  <h4 className="mb-3">Development Web .</h4>
              ...
              <div className="col-lg-4 col-md-6 col-sm-6">
                <div className="service-item mb-5">
                  ...
                  <h4 className="mb-3">CONCEPTION GRAPHIQUE.</h4>
              ...
              <div className="col-lg-4 col-md-6 col-sm-6">
                <div className="service-item mb-5">
                  ...
                  <h4 className="mb-3">COMMUNITY MANAGEMENT.</h4>
              ...
              <div className="col-lg-4 col-md-6 col-sm-6">
                <div className="service-item mb-5 mb-lg-0">
                  ...
                  <h4 className="mb-3">WEBMASTERING.</h4>
              ...
              <div className="col-lg-4 col-md-6 col-sm-6">
                <div className="service-item mb-5 mb-lg-0">
                  ...
                  <h4 className="mb-3">DEVELOPPEMENT DES APPLICATIONS MOBILES.</h4>
              ...
              <div className="col-lg-4 col-md-6 col-sm-6">
                <div className="service-item mb-5 mb-lg-0">
                  ...
                  <h4 className="mb-3">LOGICIELS SUR MESURE.</h4>
